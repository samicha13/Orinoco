...
oursContainer.className =" bg-white m-3 shadow-sm"
...
/*je crée 2 blocs pour pouvoir mettre l'image à côté du texte
    ...
    divProduct.className = " col-12 col-md-6 p-0 text-center d-flex align-items-stretch ";
...
// Ajout du texte de choix d'une option
    ...
    btnReturn.textContent = 'Retour à la lste des produits';
          ...
          let PelucheCart = {
            ...
            qty : btnQuantity.value, 
				...
				//affiche dans le local storage
			  	let PelucheOption = JSON.stringify(PelucheCart);
